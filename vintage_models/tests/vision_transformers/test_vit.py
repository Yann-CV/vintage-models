...
@pytest.fixture
def image():
    return torch.randint(0, 255, (3, 32, 32), dtype=torch.float32)


@pytest.fixture
def embedded_batches():
    return torch.randint(0, 255, (4, 64), dtype=torch.float32)


@pytest.fixture
def batches():
    return torch.randint(0, 255, (4, 768), dtype=torch.float32)
